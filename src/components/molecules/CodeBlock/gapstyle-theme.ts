// GapStyle VS — TextMate/Shiki theme (embedded so it ships in dist).
// Source: blog.gaplo.tech gaplotech theme. Do not edit by hand.
import type { ThemeRegistrationRaw } from "shiki";

export const gapstyleTheme = {
  "name": "GapStyle VS",
  "type": "dark",
  ...
  "tokenColors": [
    ...
    },
    {
      ...
      "scope": [
        ...
        "variable punctuation.definition.variable.php"
      ],
      "settings": {
        "foreground": "#CBAD96"
      }
